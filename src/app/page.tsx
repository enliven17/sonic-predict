...
export default function HomePage() {
  ...
  useEffect(() => {
    // Legacy local markets clear to ensure new Sonic seed markets show
    try { 
      localStorage.removeItem('sonic_markets'); 
      // Sonic markets'i koru, sadece eski markets'i temizle
    } catch {}
    ...
    <Container>
      <Header>
        <HeaderContent>
          ...
          <HeaderText>
            <Title>Sonic Predict Markets</Title>
            <Subtitle>Discover and bet on the most exciting Sonic ecosystem predictions</Subtitle>
          </HeaderText>
        </HeaderContent>
        <Stats>
          <StatItem>
          ...
          <StatItem>
            ...
            <StatContent>
              <StatValue>{totalPool.toFixed(1)} S</StatValue>
